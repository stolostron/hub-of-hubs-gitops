module github.com/stolostron/hub-of-hubs-nonk8s-gitops
...
replace open-cluster-management.io/multicloud-operators-subscription => github.com/vMaroon/multicloud-operators-subscription v0.6.1-0.20220311225729-28c7fd279ed7
